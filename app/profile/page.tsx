    ...
    <div style={{ minHeight: '100vh', background: '#060B18', color: '#F8FAFC', fontFamily: '-apple-system, Inter, BlinkMacSystemFont, sans-serif' }}>
      ...
      <div style={{ maxWidth: '860px', margin: '0 auto', padding: '40px 24px' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '12px', marginBottom: '16px' }}>
          {[{ num: '0', label: 'Projects' }, { num: '0', label: 'Followers' }, { num: '0', label: 'Posts' }].map((s) => (
        ...
        <div style={{ background: '#0F1C2E', border: '1px solid #1E2D45', borderRadius: '16px', padding: '26px' }}>
          ...
          {profile?.github_username ? (
            <div style={{ display: 'flex', alignItems: 'center', gap: '12px', padding: '11px 0', borderBottom: '1px solid #131F30' }}>
            ...
            <p style={{ color: '#3D5068', fontSize: '13px', fontStyle: 'italic' }}>No links added yet.</p>
          )}
          {profile?.website && (
